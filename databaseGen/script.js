    ...
    runAndOutput("DROP TABLE audit")
        ...
        .then(()=>runAndOutput(
            ...
            CREATE TABLE category (
                ...
                cat_start_amount DOUBLE NOT NULL,
        ...
        .then(()=>runAndOutput(`ALTER TABLE audit ADD CONSTRAINT fk_category_audit FOREIGN KEY ( cat_id ) REFERENCES category ( cat_id )`))
}
createTables();